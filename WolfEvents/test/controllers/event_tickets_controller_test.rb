...
class EventTicketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_ticket" do
    assert_difference('EventTicket.count') do
      post event_tickets_url, params: { event_ticket: { confirmationNumber: @event_ticket.confirmationNumber } }
    end
  ...
  test "should update event_ticket" do
    patch event_ticket_url(@event_ticket), params: { event_ticket: { confirmationNumber: @event_ticket.confirmationNumber } }
